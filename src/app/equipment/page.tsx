...
const fallbackEquipment = [
  ...
  { name: "Wheelchair", slug: "wheelchair", image: "/images/equipment/wheelchair.jpeg", images: ["/images/equipment/wheelchair.jpeg"], description: "Comfortable wheelchair with supportive seating and easy manoeuvrability.", features: ["Lightweight frame", "Removable footrests", "Folding design", "Weight capacity: 120 kg"], rateDaily: "AUD$10", rate3Days: "AUD$25", rateWeekly: "AUD$50", bestFor: "Travellers who need a wheelchair for getting around Bali." },
  { name: "Baby Push Chair", slug: "baby-push-chair", image: "/images/equipment/baby-push-chair.jpg", images: ["/images/equipment/baby-push-chair.jpg"], description: "Lightweight baby stroller for families with young children.", features: ["Ages 6 months – 4 years", "Reclining seat", "Sun canopy with UV protection", "5-point safety harness"], rateDaily: "AUD$7", rate3Days: "AUD$18", rateWeekly: "AUD$35", bestFor: "Families with young children." },
  { name: "Baby Car Seat", slug: "baby-car-seat", image: "/images/equipment/baby-car-seat.webp", images: ["/images/equipment/baby-car-seat.webp"], description: "Safe and secure baby car seat for worry-free travel around Bali.", features: ["Suitable for ages 0–4 years", "5-point safety harness", "Easy installation", "Meets safety standards"], rateDaily: "AUD$7", rate3Days: "AUD$18", rateWeekly: "AUD$35", bestFor: "Families travelling with infants or toddlers." },
  { name: "Walker Frame", slug: "walker-frame", image: "/images/equipment/walker-frame.webp", images: ["/images/equipment/walker-frame.webp"], description: "Sturdy four-wheel walker with seat, brakes, and basket.", features: ["Four-wheel design with brakes", "Built-in padded seat", "Storage basket underneath", "Adjustable height"], rateDaily: "AUD$10", rate3Days: "AUD$25", rateWeekly: "AUD$50", bestFor: "Travellers who can walk but need extra stability." },
  { name: "Shower Seat", slug: "shower-seat", image: "/images/equipment/shower-seat.jpg", images: ["/images/equipment/shower-seat.jpg"], description: "Adjustable shower chair with backrest and armrests for safe bathing.", features: ["Adjustable seat height", "Backrest and armrests", "Non-slip rubber feet", "Rust-resistant aluminium"], rateDaily: "AUD$5", rate3Days: "AUD$13", rateWeekly: "AUD$25", bestFor: "Travellers who need seated support while showering." },
  { name: "Toilet Seat", slug: "toilet-seat", image: "/images/equipment/toilet-seat.jpeg", images: ["/images/equipment/toilet-seat.jpeg"], description: "Raised toilet seat with armrests for safer bathroom use.", features: ["Height adjustable", "Padded armrests", "Fits most toilets", "Tool-free installation"], rateDaily: "AUD$5", rate3Days: "AUD$13", rateWeekly: "AUD$25", bestFor: "Anyone needing extra height or support in the bathroom." },
  { name: "Electric Wheelchair", slug: "electric-wheelchair", image: "/images/equipment/electric-wheelchair.jpeg", images: ["/images/equipment/electric-wheelchair.jpeg"], description: "Powered electric wheelchair with joystick control for effortless mobility around Bali.", features: ["Joystick control — easy one-handed operation", "Long range — up to 15km per charge", "Comfortable padded seat with armrests", "Weight capacity: 120kg", "Foldable design for transport", "Well maintained — serviced and charged before delivery"], rateDaily: "AUD$25", rate3Days: "AUD$65", rateWeekly: "AUD$130", bestFor: "Travellers who need a powered wheelchair for independent mobility around Bali." },
];
  ...
  const display = sanityEquipment.length > 0
    ? sanityEquipment.map((item: any) => ({
        ...
        images: item.images && item.images.length > 0
          ...
          : (fallbackEquipment.find(f => f.slug === item.slug)?.images || [`/images/equipment/${item.slug}.jpeg`]),
