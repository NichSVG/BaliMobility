...
const fallbackFaq = [
  ...
  { category: "Equipment & Rental", question: "Can I rent equipment for just one day?", answer: "Yes! We offer daily, 3-day, and weekly rates with no minimum rental period. If you only need a wheelchair for a day trip or a scooter for one outing, that's completely fine." },
